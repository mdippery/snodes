...
package snodes.command.Transfer;
...
/**
 * The Transfer.Private command class.
 *
 * @author Michael Schoonmaker
 * @version 0.1
 */
public class Private implements Command {
	/**
	...
	/**
	 * Instantiates a new private transfer via dialog box.
	 *
	 * @param actionCommand
